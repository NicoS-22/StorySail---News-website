            ...
            @if ($metaType == "tags")
                <td>
                    <form action="{{route('admin.editTag', ['tag'=>$metaInfo])}}" method="POST">
                        ...
                        <button type="submit" class="btn accentBg btnCus">Aggiorna</button>
                    </form>
                </td>
                <td>
                    <form action="{{route('admin.deleteTag',['tag'=> $metaInfo])}}" method="POST">
                        @csrf 
                        @method('delete')
                        <button type="submit" class="btn accentBg btnCus">Elimina</button>
                    </form>
                </td>
                @else
                <td>
                ...
                <td>
                    <form action="{{route('admin.deleteCategory', ['catory' =>$metainfo])}}" method="POST">
                        @csrf 
                        @method('delete')
                        <button type="submit" class="btn accentBg btnCus">Elimina</button>
                    </form>
